	...
	.recipe(
		...
		.recipe__content
			...
			button.btn-reset(
				...
				svg.icon(version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 473.677 473.677' style='enable-background:new 0 0 473.677 473.677;' xml:space='preserve')
					path(style='fill:#000;' d='M0,236.84C0,106.026,106.036,0.002,236.835,0.002c130.807,0,236.842,106.028,236.842,236.838\
